...
export function CtaSection() {
  return (
    <section className="relative py-32 px-6 md:px-8 overflow-hidden">
      {/* Background glow */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,#6A0DAD15_0%,transparent_70%)] pointer-events-none" />

      <div className="scroll-animate relative mx-auto max-w-4xl text-center">
        {/* Decorative grid behind */}
        <div className="absolute inset-0 -z-10 opacity-30 bg-[linear-gradient(to_right,#6A0DAD22_1px,transparent_1px),linear-gradient(to_bottom,#6A0DAD22_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_60%_at_50%_50%,#000_40%,transparent_100%)]" />
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button
            asChild
            className="rounded-lg bg-[#6A0DAD] text-white hover:bg-[#7b1fc4] hover:shadow-[0_0_30px_rgba(106,13,173,0.4)] text-base font-medium h-12 px-8 transition-all"
          >
            <Link href="/signup">
              Get Started Free
          ...
          <Button
            asChild
            variant="outline"
            className="rounded-lg border-[#6A0DAD]/30 bg-transparent text-white hover:bg-[#6A0DAD]/10 hover:border-[#6A0DAD]/50 text-base font-medium h-12 px-8"
          >
